...
import Button from '../../../components/ui/Button/Button'; // Importar o componente Button
import InputField from '../../../components/ui/InputField/InputField'; // Importar para o formulário
...
const MySocialProofsPage = ({ user }) => {
  ...
  const handleUpdateProof = async (e) => {
    ...
    // Criamos um FormData para enviar a descrição e os novos arquivos
    ...
    try {
      // Chamada para a nova rota da API
      ...
      fetchUserProofs(); // Re-busca os dados para mostrar a atualização
    } catch (error) {
  ...
  return (
    <ContentWrapper title="Minhas Provas Sociais">
      ...
      {/* Modal de Feedback (já existente) */}
